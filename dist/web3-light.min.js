require = function t(e, n, r) {
    ...
    20: [function(t, e, n) {
        var r = t("bignumber.js"),
            ...
            v = function(t) {
                if (P(t)) return y(+t);
                if (C(t)) return y(t);
                if (I(t)) return f(JSON.stringify(t));
                if (A(t)) {
                    if (0 === t.indexOf("-0x")) return y(t);
            ...
            g = function(t) {
                ...
                var e = i[t];
                if (void 0 === e) throw new Error("This unit doesn't exists, please use the one of the following units" + JSON.stringify(i, null, 2));
                return new r(e, 10)
            },
            b = function(t, e) {
                var n = w(t).dividedBy(g(e));
                return C(t) ? n : n.toString(10)
            },
            _ = function(t, e) {
                var n = w(t).times(g(e));
                return C(t) ? n : n.toString(10)
            ...
            w = function(t) {
                return t = t || 0, C(t) ? t : !A(t) || 0 !== t.indexOf("0x") && 0 !== t.indexOf("-0x") ? new r(t.toString(10), 10) : new r(t.replace("0x", ""), 16)
            },
            x = function(t) {
                var e = w(t);
            ...
            S = function(t) {
                return k(t) ? t : /^[0-9a-f]{40}$/.test(t) ? "0x" + t : "0x" + a(v(t).substr(2), 40)
            },
            C = function(t) {
    ...
    22: [function(t, e, n) {
        var r = t("./version.json"),
            o = t("./web3/methods/net"),
            i = t("./web3/methods/eth"),
            a = t("./web3/methods/db"),
            s = t("./web3/methods/shh"),
            c = t("./web3/methods/watches"),
            u = t("./web3/filter"),
            f = t("./web3/syncing"),
            p = t("./utils/utils"),
            l = t("./web3/formatters"),
            h = t("./web3/requestmanager"),
            d = t("./utils/config"),
            m = t("./web3/property"),
            y = t("./web3/batch"),
            v = t("./utils/sha3"),
            ...
            x = {};
        x.providers = {}, x.currentProvider = null, x.version = {}, x.version.api = r.version, x.eth = {}, x.eth.isSyncing = function(t) {
            return new f(t)
        }, x.eth.filter = function(t, e) {
            return new u(t, c.eth(), l.outputLogFormatter, e)
        }, x.shh = {}, x.shh.filter = function(t, e) {
            return new u(t, c.shh(), l.outputPostFormatter, e)
        }, x.net = {}, x.db = {}, x.setProvider = function(t) {
            this.currentProvider = t, h.getInstance().setProvider(t)
        }, x.isConnected = function() {
            return this.currentProvider && this.currentProvider.isConnected()
        }, x.reset = function(t) {
            h.getInstance().reset(t), d.defaultBlock = "latest", d.defaultAccount = void 0
        }, x.toHex = p.toHex, x.toAscii = p.toAscii, x.toUtf8 = p.toUtf8, x.fromAscii = p.fromAscii, x.fromUtf8 = p.fromUtf8, x.toDecimal = p.toDecimal, x.fromDecimal = p.fromDecimal, x.toBigNumber = p.toBigNumber, x.toWei = p.toWei, x.fromWei = p.fromWei, x.isAddress = p.isAddress, x.isIBAN = p.isIBAN, x.sha3 = v, x.createBatch = function() {
            return new y
        }, x.fromICAP = function(t) {
            var e = new g(t);
            return e.address()
        }, Object.defineProperty(x.eth, "defaultBlock", {
            get: function() {
                return d.defaultBlock
            },
            set: function(t) {
                return d.defaultBlock = t, t
            }
        }), Object.defineProperty(x.eth, "defaultAccount", {
            get: function() {
                return d.defaultAccount
            },
            set: function(t) {
                return d.defaultAccount = t, t
            }
        }), x._extend = function(t) {
            t.property && !x[t.property] && (x[t.property] = {}), _(x[t.property] || x, t.methods || []), w(x[t.property] || x, t.properties || [])
        }, x._extend.formatters = l, x._extend.utils = p, x._extend.Method = t("./web3/method"), x._extend.Property = t("./web3/property"), w(x, b), _(x.net, o.methods), w(x.net, o.properties), _(x.eth, i.methods), w(x.eth, i.properties), _(x.db, a.methods), _(x.shh, s.methods), e.exports = x
    }, {
        "./utils/config": 18,
        "./utils/sha3": 19,
        "./utils/utils": 20,
        ...
        "./web3/methods/net": 38,
        "./web3/methods/shh": 39,
        "./web3/methods/watches": 40,
        "./web3/property": 42,
        "./web3/requestmanager": 43,
        "./web3/syncing": 44
    }],
    23: [function(t, e, n) {
        var r = t("../utils/sha3"),
    ...
    24: [function(t, e, n) {
        ...
        a.prototype.add = function(t) {
            ...
            var t = this.requests;
            r.getInstance().sendBatch(t, function(e, n) {
                n = n || [], t.map(function(t, e) {
                    return n[e] || {}
                }).forEach(function(e, n) {
                    if (t[n].callback) {
                        if (!o.getInstance().isValidResponse(e)) return t[n].callback(i.InvalidResponse(e));
    ...
    25: [function(t, e, n) {
        var r = t("../web3"),
            ...
            p = function(t, e) {
                var n = e.filter(function(t) {
                    ...
                    r = new c(n, t.address);
                r.attachToContract(t), n.map(function(e) {
            ...
            h = function(t, e, n) {
                var o = 0,
                    i = !1,
                    a = r.eth.filter("latest", function(s) {
                        if (!s && !i)
                            if (o++, o > 50) {
                                if (a.stopWatching(), i = !0, !n) throw new Error("Contract transaction couldn't be found after 50 blocks");
                                n(new Error("Contract transaction couldn't be found after 50 blocks"))
                            } else r.eth.getTransactionReceipt(t.transactionHash, function(o, s) {
                                s && !i && r.eth.getCode(s.contractAddress, function(r, o) {
                                    if (!i)
                                        if (a.stopWatching(), i = !0, o.length > 2) t.address = s.contractAddress, f(t, e), p(t, e), n && n(null, t);
                                        else {
        ...
        d.prototype["new"] = function() {
            ...
            o.isFunction(a[a.length - 1]) && (t = a.pop());
            var s = a[a.length - 1];
            o.isObject(s) && !o.isArray(s) && (i = a.pop());
            var c = u(this.abi, a);
            if (i.data += c, t) r.eth.sendTransaction(i, function(r, o) {
                r ? t(r) : (n.transactionHash = o, t(null, n), h(n, e.abi, t))
            });
            else {
                var f = r.eth.sendTransaction(i);
                n.transactionHash = f, h(n, e.abi)
            }
            return n
        }, d.prototype.at = function(t, e) {
            var n = new m(this.abi, t);
            return f(n, this.abi), p(n, this.abi), e && e(null, n), n
        };
        var m = function(t, e) {
            this.address = e
        };
    ...
    26: [function(t, e, n) {
        e.exports = {
            ...
            InvalidConnection: function(t) {
                return new Error("CONNECTION ERROR: Couldn't connect to node " + t + ", is it running?")
            },
            InvalidProvider: function() {
                return new Error("Provider not set or invalid")
            },
            InvalidResponse: function(t) {
                var e = t && t.error && t.error.message ? t.error.message : "Invalid JSON RPC response: " + t;
                return new Error(e)
            }
        }
    }, {}],
    27: [function(t, e, n) {
        var r = t("../utils/utils"),
            ...
            c = t("./methods/watches"),
            u = function(t, e) {
                this._params = t.inputs, this._name = r.transformToFullName(t), this._address = e, this._anonymous = t.anonymous
            };
    ...
    28: [function(t, e, n) {
        var r = t("./requestmanager"),
            ...
            i = t("../utils/utils"),
            a = function(t) {
                return null === t || "undefined" == typeof t ? null : (t = String(t), 0 === t.indexOf("0x") ? t : i.fromUtf8(t))
            },
            s = function(t) {
                return i.isString(t) ? t : (t = t || {}, t.topics = t.topics || [], t.topics = t.topics.map(function(t) {
                    return i.isArray(t) ? t.map(a) : a(t)
                }), {
                    topics: t.topics,
                    to: t.to,
                    address: t.address,
                    fromBlock: o.inputBlockNumberFormatter(t.fromBlock),
                    toBlock: o.inputBlockNumberFormatter(t.toBlock)
                })
            },
            c = function(t, e) {
                i.isString(t.options) || t.get(function(t, n) {
                    t && e(t), i.isArray(n) && n.forEach(function(t) {
                        e(null, t)
                    })
                })
            },
            u = function(t) {
                var e = function(e, n) {
                    return e ? t.callbacks.forEach(function(t) {
                        t(e)
                    }) : void(i.isArray(n) && n.forEach(function(e) {
                        e = t.formatter ? t.formatter(e) : e, t.callbacks.forEach(function(t) {
                            t(null, e)
                        })
                    }))
                };
                r.getInstance().startPolling({
            ...
            f = function(t, e, n, r) {
                ...
                return e.forEach(function(t) {
                    t.attachToObject(i)
                }), this.options = s(t), this.implementation = i, this.filterId = null, this.callbacks = [], this.getLogsCallbacks = [], this.pollFilters = [], this.formatter = n, this.implementation.newFilter(this.options, function(t, e) {
                    if (t) o.callbacks.forEach(function(e) {
                        e(t)
                    });
                    else if (o.filterId = e, o.getLogsCallbacks.forEach(function(t) {
                            o.get(t)
                        }), o.getLogsCallbacks = [], o.callbacks.forEach(function(t) {
                            c(o, t)
                        }), o.callbacks.length > 0 && u(o), r) return o.watch(r)
                }), this
            };
        f.prototype.watch = function(t) {
            return this.callbacks.push(t), this.filterId && (c(this, t), u(this)), this
        }, f.prototype.stopWatching = function() {
            r.getInstance().stopPolling(this.filterId), this.implementation.uninstallFilter(this.filterId, function() {}), this.callbacks = []
    ...
    29: [function(t, e, n) {
        var r = t("../utils/utils"),
            ...
            y = function(t) {
                return t.payload = r.toHex(t.payload), t.ttl = r.fromDecimal(t.ttl), t.workToProve = r.fromDecimal(t.workToProve), t.priority = r.fromDecimal(t.priority), r.isArray(t.topics) || (t.topics = t.topics ? [t.topics] : []), t.topics = t.topics.map(function(t) {
                    return r.fromUtf8(t)
                }), t
            },
            v = function(t) {
                return t.expiry = r.toDecimal(t.expiry), t.sent = r.toDecimal(t.sent), t.ttl = r.toDecimal(t.ttl), t.workProved = r.toDecimal(t.workProved), t.payloadRaw = t.payload, t.payload = r.toUtf8(t.payload), r.isJson(t.payload) && (t.payload = JSON.parse(t.payload)), t.topics || (t.topics = []), t.topics = t.topics.map(function(t) {
                    return r.toUtf8(t)
                }), t
            },
            g = function(t) {
        ...
        var r = t("../web3"),
            ...
            c = function(t, e) {
                this._inputTypes = t.inputs.map(function(t) {
                    ...
                    return t.type
                }), this._constant = t.constant, this._name = i.transformToFullName(t), this._address = e
            };
        c.prototype.extractCallback = function(t) {
            return i.isFunction(t[t.length - 1]) ? t.pop() : void 0
        }, c.prototype.extractDefaultBlock = function(t) {
            return t.length > this._inputTypes.length && !i.isObject(t[t.length - 1]) ? a.inputDefaultBlockNumberFormatter(t.pop()) : void 0
        }, c.prototype.toPayload = function(t) {
            var e = {};
            return t.length > this._inputTypes.length && i.isObject(t[t.length - 1]) && (e = t[t.length - 1]), e.to = this._address, e.data = "0x" + this.signature() + o.encodeParams(this._inputTypes, t), e
        }, c.prototype.signature = function() {
            return s(this._name).slice(0, 8)
        }, c.prototype.unpackOutput = function(t) {
            if (t) {
                t = t.length >= 2 ? t.slice(2) : t;
                var e = o.decodeParams(this._outputTypes, t);
            ...
            var t = Array.prototype.slice.call(arguments).filter(function(t) {
                ...
                o = this.toPayload(t);
            if (!e) {
                var i = r.eth.call(o, n);
                return this.unpackOutput(i)
            }
            var a = this;
            r.eth.call(o, n, function(t, n) {
                e(t, a.unpackOutput(n))
            })
            ...
            var t = Array.prototype.slice.call(arguments).filter(function(t) {
                ...
                e = this.extractCallback(t),
                n = this.toPayload(t);
            return e ? void r.eth.sendTransaction(n, e) : r.eth.sendTransaction(n)
        }, c.prototype.estimateGas = function() {
            var t = Array.prototype.slice.call(arguments),
                e = this.extractCallback(t),
                n = this.toPayload(t);
            return e ? void r.eth.estimateGas(n, e) : r.eth.estimateGas(n)
            ...
            var e = this.execute.bind(this);
            e.request = this.request.bind(this), e.call = this.call.bind(this), e.sendTransaction = this.sendTransaction.bind(this), e.estimateGas = this.estimateGas.bind(this);
    ...
    33: [function(t, e, n) {
        ...
        var r = t("../utils/utils"),
            ...
            i = function(t, e) {
                var n = {
                    ...
                    error: {
                        code: -32603,
                        message: "IPC Request timed out for method  '" + t + "'"
                    },
                    id: e
                };
        ...
        a.prototype._parseResponse = function(t) {
            var e = this,
                n = [],
                r = t.replace(/\}\{/g, "}|--|{").replace(/\}\]\[\{/g, "}]|--|[{").replace(/\}\[\{/g, "}|--|[{").replace(/\}\]\{/g, "}]|--|{").split("|--|");
            return r.forEach(function(t) {
                ...
                try {
                    ...
                    return e.lastChunk = t, clearTimeout(e.lastChunkTimeout), void(e.lastChunkTimeout = setTimeout(function() {
                        throw e.timeout(), o.InvalidResponse(t)
                    }, 15e3))
                }
            ...
            for (var t in this.responseCallbacks) this.responseCallbacks.hasOwnProperty(t) && (this.responseCallbacks[t](i(this.responseCallbacks[t].method, t)), delete this.responseCallbacks[t])
    ...
    35: [function(t, e, n) {
        var r = t("./requestmanager"),
            ...
            i = t("./errors"),
            a = function(t) {
                this.name = t.name, this.call = t.call, this.params = t.params || 0, this.inputFormatter = t.inputFormatter, this.outputFormatter = t.outputFormatter
            };
        a.prototype.getCall = function(t) {
            return o.isFunction(this.call) ? this.call(t) : this.call
        }, a.prototype.extractCallback = function(t) {
            return o.isFunction(t[t.length - 1]) ? t.pop() : void 0
        }, a.prototype.validateArgs = function(t) {
            if (t.length !== this.params) throw i.InvalidNumberOfParams()
            ...
            var e = this.send.bind(this);
            e.request = this.request.bind(this), e.call = this.call;
            ...
            if (t.callback) {
                var e = this;
                return r.getInstance().sendAsync(t, function(n, r) {
                    t.callback(n, e.formatOutput(r))
                })
            }
            return this.formatOutput(r.getInstance().send(t))
        }, e.exports = a
    }, {
        "../utils/utils": 20,
        "./errors": 26,
    ...
    37: [function(t, e, n) {
        ...
        var r = t("../formatters"),
            ...
            m = new i({
                ...
                call: s,
                params: 2,
                inputFormatter: [r.inputBlockNumberFormatter, function(t) {
                    return !!t
                }],
            ...
            O = [l, h, d, m, y, v, g, b, _, w, x, k, C, A, B, S, F, I, P, D, T],
            N = [new a({
                name: "coinbase",
                getter: "eth_coinbase"
            }), new a({
    ...
    41: [function(t, e, n) {
        var r = t("./contract"),
            o = t("../contracts/GlobalRegistrar.json"),
            i = t("../contracts/ICAPRegistrar.json"),
            a = "0xc6d9d2cd449a754c494264e1809c50e34d64562b",
            s = "0xa1a111bc074c9cfa781f0c38e63bd51c91b8af00";
        e.exports = {
            namereg: r(o).at(a),
            ibanNamereg: r(i).at(s)
        }
    }, {
    ...
    42: [function(t, e, n) {
        var r = t("./requestmanager"),
            o = t("../utils/utils"),
            i = function(t) {
                this.name = t.name, this.getter = t.getter, this.setter = t.setter, this.outputFormatter = t.outputFormatter, this.inputFormatter = t.inputFormatter
            };
        i.prototype.formatInput = function(t) {
            ...
            var e = {
                ...
                n = this.name.split("."),
                r = n[0];
            n.length > 1 && (t[n[0]] = t[n[0]] || {}, t = t[n[0]], r = n[1]), Object.defineProperty(t, r, e);
            var o = function(t, e) {
                    return t + e.charAt(0).toUpperCase() + e.slice(1)
                },
                i = this.getAsync.bind(this);
            i.request = this.request.bind(this), t[o("get", r)] = i
        }, i.prototype.get = function() {
            return this.formatOutput(r.getInstance().send({
                method: this.getter
            }))
        }, i.prototype.getAsync = function(t) {
            var e = this;
            r.getInstance().sendAsync({
                method: this.getter
            }, function(n, r) {
                return n ? t(n) : void t(n, e.formatOutput(r))
            })
    ...
    43: [function(t, e, n) {
        var r = t("./jsonrpc"),
            ...
            a = t("./errors"),
            s = function(t) {
                return arguments.callee._singletonInstance ? arguments.callee._singletonInstance : (arguments.callee._singletonInstance = this, this.provider = t, this.polls = {}, this.timeout = null, void(this.isPolling = !1))
            };
        s.getInstance = function() {
            ...
            this.provider = t, this.provider && !this.isPolling && (this.poll(), this.isPolling = !0)
            ...
            this.timeout && (clearTimeout(this.timeout), this.timeout = null), this.poll()
    ...
    44: [function(t, e, n) {
        var r = t("./requestmanager"),
            ...
            s = function(t) {
                var e = !1,
                    n = function(n, r) {
                        return n ? t.callbacks.forEach(function(t) {
                            t(n)
                        }) : (a.isObject(r) && (r = t.implementation.outputFormatter(r)), void t.callbacks.forEach(function(t) {
                            e !== r && (!e && a.isObject(r) && t(null, !0), setTimeout(function() {
                                t(null, r)
                            }, 1), e = r)
                        }))
                    };
                r.getInstance().startPolling({
                    method: t.implementation.call,
                    params: []
                }, t.pollId, n, t.stopWatching.bind(t))
            },
            c = function(t) {
                return this.pollId = "syncPoll_" + Math.floor(1e3 * Math.random()), this.callbacks = [], this.implementation = new o({
                    name: "isSyncing",
                    call: "eth_syncing",
                    params: 0,
                    outputFormatter: i.outputSyncingFormatter
                }), this.addCallback(t), s(this), this
            };
        c.prototype.addCallback = function(t) {
            return t && this.callbacks.push(t), this
        }, c.prototype.stopWatching = function() {
            r.getInstance().stopPolling(this.pollId), this.callbacks = []
        }, e.exports = c
    }, {
        "../utils/utils": 20,
        "./formatters": 29,
    ...
    45: [function(t, e, n) {
        var r = t("../web3"),
            o = t("./iban"),
            i = t("./namereg").ibanNamereg,
            a = t("./contract"),
            s = t("../contracts/SmartExchange.json"),
            c = function(t, e, n, r) {
                var a = new o(e);
                if (!a.isValid()) throw new Error("invalid iban address");
                if (a.isDirect()) return u(t, a.address(), n, r);
                if (!r) {
                    var s = i.addr(a.institution());
                    return f(t, s, n, a.client())
                }
                i.addr(a.institution(), function(e, o) {
                    return f(t, o, n, a.client(), r)
                })
            },
            u = function(t, e, n, o) {
                return r.eth.sendTransaction({
                    address: e,
                    from: t,
                    value: n
                }, o)
                        ...
                        compute: function(t, e) {
                            for (var n = this.cfg, r = s.create(n.hasher, t), i = o.create(), a = o.create([1]), c = i.words, u = a.words, f = n.keySize, p = n.iterations; c.length < f;) {
                                ...
                                for (var h = l.words, d = h.length, m = l, y = 1; p > y; y++) {
                                    ...
                                    for (var v = m.words, g = 0; d > g; g++) h[g] ^= v[g]
                                }
                                i.concat(l), u[0]++
                            }
                ...
                var c = t,
                    ...
                    b = l.RIPEMD160 = p.extend({
                        ...
                        _doProcessBlock: function(t, e) {
                            ...
                            for (var N, c = 0; 80 > c; c += 1) N = p + t[e + P[c]] | 0, N += 16 > c ? n(l, b, _) + F[0] : 32 > c ? r(l, b, _) + F[1] : 48 > c ? o(l, b, _) + F[2] : 64 > c ? i(l, b, _) + F[3] : a(l, b, _) + F[4], N = 0 | N, N = s(N, T[c]), N = N + w | 0, p = w, w = _, _ = s(b, 10), b = l, l = N, N = x + t[e + D[c]] | 0, N += 16 > c ? a(k, B, S) + I[0] : 32 > c ? i(k, B, S) + I[1] : 48 > c ? o(k, B, S) + I[2] : 64 > c ? r(k, B, S) + I[3] : n(k, B, S) + I[4], N = 0 | N, N = s(N, O[c]), N = N + C | 0, x = C, C = S, S = s(B, 10), B = k, k = N;
                            N = A[1] + b + S | 0, A[1] = A[2] + _ + C | 0, A[2] = A[3] + w + x | 0, A[3] = A[4] + p + k | 0, A[4] = A[0] + l + B | 0, A[0] = N
                        },
                        _doFinalize: function() {
                            var t = this._data,
                                e = t.words,
                ...
                var h = c.SHA3 = i.extend({
                    ...
                    _doProcessBlock: function(t, e) {
                        ...
                        for (var c = 0; 24 > c; c++) {
                            ...
                            for (var h = 0; 5 > h; h++)
                                for (var g = l[(h + 4) % 5], b = l[(h + 1) % 5], _ = b.high, w = b.low, d = g.high ^ (_ << 1 | w >>> 31), m = g.low ^ (w << 1 | _ >>> 31), y = 0; 5 > y; y++) {
                                    var s = n[h + 5 * y];
                                    s.high ^= d, s.low ^= m
                                }
                            for (var x = 1; 25 > x; x++) {
        ...
        ! function(r, o, i) {
            ...
            return function() {
                ...
                var p = c.SHA512 = o.extend({
                    ...
                    _doProcessBlock: function(t, e) {
                        for (var n = this._hash.words, r = n[0], o = n[1], i = n[2], a = n[3], s = n[4], c = n[5], p = n[6], l = n[7], h = r.high, d = r.low, m = o.high, y = o.low, v = i.high, g = i.low, b = a.high, _ = a.low, w = s.high, x = s.low, k = c.high, B = c.low, S = p.high, C = p.low, A = l.high, F = l.low, I = h, P = d, D = m, T = y, O = v, N = g, H = b, E = _, R = w, j = x, z = k, L = B, M = S, U = C, J = A, W = F, q = 0; 80 > q; q++) {
                            var G = f[q];
                            if (16 > q) var X = G.high = 0 | t[e + 2 * q],
                                K = G.low = 0 | t[e + 2 * q + 1];
                            else {
                                var V = f[q - 15],
                                    $ = V.high,
                            ...
                            var pt = R & z ^ ~R & M,
                                ...
                                vt = (R >>> 14 | j << 18) ^ (R >>> 18 | j << 14) ^ (R << 23 | j >>> 9),
                                gt = (j >>> 14 | R << 18) ^ (j >>> 18 | R << 14) ^ (j << 23 | R >>> 9),
                                bt = u[q],
                                _t = bt.high,
                                wt = bt.low,
                                xt = W + gt,
                                kt = J + vt + (W >>> 0 > xt >>> 0 ? 1 : 0),
                                xt = xt + lt,
                            ...
                            J = M, W = U, M = z, U = L, z = R, L = j, j = E + xt | 0, R = H + kt + (E >>> 0 > j >>> 0 ? 1 : 0) | 0, H = O, E = N, O = D, N = T, D = I, T = P, P = xt + Bt | 0, I = kt + St + (xt >>> 0 > P >>> 0 ? 1 : 0) | 0
                        }
                        d = r.low = d + P, r.high = h + I + (P >>> 0 > d >>> 0 ? 1 : 0), y = o.low = y + T, o.high = m + D + (T >>> 0 > y >>> 0 ? 1 : 0), g = i.low = g + N, i.high = v + O + (N >>> 0 > g >>> 0 ? 1 : 0), _ = a.low = _ + E, a.high = b + H + (E >>> 0 > _ >>> 0 ? 1 : 0), x = s.low = x + j, s.high = w + R + (j >>> 0 > x >>> 0 ? 1 : 0), B = c.low = B + L, c.high = k + z + (L >>> 0 > B >>> 0 ? 1 : 0), C = p.low = C + U, p.high = S + M + (U >>> 0 > C >>> 0 ? 1 : 0), F = l.low = F + W, l.high = A + J + (W >>> 0 > F >>> 0 ? 1 : 0)
                    },
                    _doFinalize: function() {
                        var t = this._data,
                            e = t.words,
