...
AbiHtml.prototype.FromRegex = function(str) {
    ...
    while (match = re.exec(str)) {
        ...
        if (abiItem.type === 'event' && 'anonymous' in modifiers) abiItem.anonymous = modifiers.indexed
        if (abiItem.type === 'function' && 'constant' in modifiers) abiItem.constant = modifiers.constant
